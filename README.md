...
从 [Releases](https://github.com) 下载，或自行构建（见底部「从源码构建」）。
...
- **2,790 个测试** — 全部在 .NET 8 + .NET Framework 4.8 双目标通过
- **Python 交叉验证** — STATS.* 与 numpy/scipy 对比，精度 1e-10（[数据](tests/TestData/Cross_Validation_vs_Python.xlsx)）
