...
- **数字唯一基准**：[api-reference.md](docs/specification/api-reference.md) — 240 UDF 签名以此为准
...
| [api-reference.md](docs/specification/api-reference.md) | 数字唯一信源 | 240 UDF 签名、参数、错误行为 |
