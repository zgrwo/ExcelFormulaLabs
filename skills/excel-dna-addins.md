...
- `src/Analytics/bin/Release/net48/publish/Analytics-AddIn-net48-packed.xll`       (.NET Framework 4.8)
- `src/DataToolkit/bin/Release/net8.0-windows/publish/DataToolkit-AddIn-net8.0-packed.xll`  (.NET 8)
- `src/DataToolkit/bin/Release/net48/publish/DataToolkit-AddIn-net48-packed.xll`           (.NET Framework 4.8)
