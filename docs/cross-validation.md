# Cross-Validation Report — ExcelFormulaLabs v2.2.5
...
## 1. STATS — Descriptive Statistics (34 UDFs)
...
## 2. LINALG — Linear Algebra (28 UDFs)
...
## 3. REGRESS — Regression Analysis (10 UDFs)
