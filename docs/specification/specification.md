...
- 2,866 个 [Fact] 与 18 个 [Theory]（xUnit + FluentAssertions；2026-09-23 实测回填：Foundation 434 + Analytics 912 + DataToolkit 1,520；含安全回归子集与审查缺陷复现回归、[Theory] 哨兵参数化用例。verify-docs 检查 20 强制这些声明 == tests/**/*.cs 实测计数）
