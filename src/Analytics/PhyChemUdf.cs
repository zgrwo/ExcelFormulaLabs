...
namespace ExcelVbaLibraries.Analytics
{
    public static class PhyChemUdf
    {
        ...
        [ExcelFunction(Name="PHYCHEM.C_TO_F")] public static object UDF_PC_CTOF(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d*9/5+32));
        [ExcelFunction(Name="PHYCHEM.F_TO_C")] public static object UDF_PC_FTOC(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>(d-32)*5/9));
        [ExcelFunction(Name="PHYCHEM.KG_TO_LB")] public static object UDF_PC_KG2LB(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d*2.20462));
        [ExcelFunction(Name="PHYCHEM.LB_TO_KG")] public static object UDF_PC_LB2KG(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d/2.20462));
        [ExcelFunction(Name="PHYCHEM.L_TO_GAL")] public static object UDF_PC_L2GAL(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d*0.264172));
        [ExcelFunction(Name="PHYCHEM.GAL_TO_L")] public static object UDF_PC_GAL2L(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d/0.264172));
        [ExcelFunction(Name="PHYCHEM.ATM_TO_PSI")] public static object UDF_PC_ATM2PSI(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d*14.6959));
        [ExcelFunction(Name="PHYCHEM.PSI_TO_ATM")] public static object UDF_PC_PSI2ATM(object v)=>OutputWrapper.WrapError(()=>ElementWiseMapper.MapOver<double,double>(v,d=>d/14.6959));
