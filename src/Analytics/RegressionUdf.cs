...
namespace ExcelVbaLibraries.Analytics
{
    public static class RegressionUdf
    {
        ...
        [ExcelFunction(Name = "REGRESS.RIDGE",
          Description = "Ridge regression (L2 regularization). Returns 2xn: coefficients, sse, r_squared, residuals, fitted_values, lambda, n, df. No se/t/p values (inference invalid under regularization).")]
