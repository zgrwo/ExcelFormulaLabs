<DnaLibrary Name="DataToolkit Add-In (.NET Framework)" RuntimeVersion="v4.0" ExplicitExports="true">
  ...
  <ExternalLibrary Path="System.Data.SQLite.dll" Pack="true" ExplicitExports="true" />
