...
namespace ExcelVbaLibraries.DataToolkit
{
    public static class RangeExportUdf
    {
        ...
        [ExcelFunction(Name="RANGE.TOCSV", Description="Export range to CSV with custom delimiter")] public static object UDF_RANGE_CSV(object d,object dl,object q)=>OutputWrapper.WrapError(()=>RangeExportCore.RangeToCsv(D(d),InputNormalizer.ToString(dl),InputNormalizer.ToBool(q)));
