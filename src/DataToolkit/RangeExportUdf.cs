...
namespace ExcelVbaLibraries.DataToolkit
{
    public static class RangeExportUdf
    {
        ...
        [ExcelFunction(Name="RANGE.TOCSV", Description="Export range to CSV with custom delimiter. 3rd param: TRUE to quote fields")] public static object UDF_RANGE_CSV([ExcelArgument(Name="source_range", Description="The input range or 2D array")] object d, [ExcelArgument(Name="delimiter", Description="The delimiter character or string")] object dl, [Optional, ExcelArgument(Name="quote_fields", Description="TRUE to quote all fields; FALSE for minimal quoting")] object q)=>OutputWrapper.WrapError(()=>RangeExportCore.RangeToCsv(D(d),InputNormalizer.ToString(dl),InputNormalizer.ToBool(q)));
