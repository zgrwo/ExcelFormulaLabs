...
namespace ExcelVbaLibraries.DataToolkit
{
    public static class ArrayUdf
    {
        ...
        [ExcelFunction(Name="ARR.SORT", Description="Sort array. asc=true/false, mode=auto/text/numeric")] public static object UDF_ARR_SORT([ExcelArgument("array")] object a, [ExcelArgument("asc")] object asc, [ExcelArgument("mode")] object mode)=>OutputWrapper.WrapError(()=>ArrayCore.Sort(A(a),InputNormalizer.ToBool(asc),InputNormalizer.ToString(mode)));
        ...
        [ExcelFunction(Name="ARR.UNIQUE", Description="Return unique values from an array")] public static object UDF_ARR_UNIQUE([ExcelArgument("array_2d")] object a)=>OutputWrapper.WrapError(()=>ArrayCore.Unique(A(a)));
        [ExcelFunction(Name="ARR.INDEXOF", Description="Zero-based index of first occurrence, or -1 if not found")] public static object UDF_ARR_INDEXOF([ExcelArgument("array")] object a, [ExcelArgument("value")] object v)=>OutputWrapper.WrapError(()=>(long)ArrayCore.IndexOf(A(a),v));
        [ExcelFunction(Name="ARR.SLICE", Description="Extract l elements from an array starting at index s")] public static object UDF_ARR_SLICE([ExcelArgument("array")] object a, [ExcelArgument("start")] object s, [ExcelArgument("len")] object l)=>OutputWrapper.WrapError(()=>ArrayCore.Slice(A(a),InputNormalizer.ToLong(s),InputNormalizer.ToLong(l)));
        ...
        [ExcelFunction(Name="ARR.FILTER", Description="Filter array by comparison operator: =, <>, >, <, >=, <=")] public static object UDF_ARR_FILTER([ExcelArgument("array")] object a, [ExcelArgument("criteria")] object c, [ExcelArgument("op")] object op)=>OutputWrapper.WrapError(()=>ArrayCore.Filter(A(a),c,InputNormalizer.ToString(op)));
        ...
        [ExcelFunction(Name="ARR.CONCAT", Description="Concatenate two arrays")] public static object UDF_ARR_CONCAT([ExcelArgument("a")] object a, [ExcelArgument("b")] object b)=>OutputWrapper.WrapError(()=>ArrayCore.Concat(A(a),A(b)));
        ...
        [ExcelFunction(Name="ARR.CONTAINS", Description="Returns TRUE if value exists in array")] public static object UDF_ARR_CONTAINS([ExcelArgument("array")] object a, [ExcelArgument("value")] object v)=>OutputWrapper.WrapError(()=>(object)ArrayCore.Contains(A(a),v));
        ...
        [ExcelFunction(Name="ARR.FILL", Description="Create array of length n filled with value v")] public static object UDF_ARR_FILL([ExcelArgument("value")] object v, [ExcelArgument("n")] object n)=>OutputWrapper.WrapError(()=>{long c=InputNormalizer.ToLong(n);var r=new object[c];for(int i=0;i<c;i++)r[i]=v;return r;});
        ...
        [ExcelFunction(Name="ARR.SHUFFLE", Description="Randomly shuffle array elements (Fisher-Yates)")] public static object UDF_ARR_SHUFFLE([ExcelArgument("array")] object a)=>OutputWrapper.WrapError(()=>ArrayCore.Shuffle(A(a)));
    }
}
