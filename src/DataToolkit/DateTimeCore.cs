...
namespace ExcelVbaLibraries.DataToolkit
{
    ...
    internal static class DateTimeCore
    {
        ...
        internal static long DateDiff(string u, DateTime d1, DateTime d2) => u.ToUpperInvariant() switch { "D" or "DAY" => (long)(d2 - d1).TotalDays, "M" or "MONTH" => ((d2.Year - d1.Year) * 12 + d2.Month - d1.Month), "Y" or "YEAR" => d2.Year - d1.Year - (d2.DayOfYear < d1.DayOfYear ? 1 : 0), _ => 0 };
    }
}
