...
namespace ExcelVbaLibraries.DataToolkit
{
    ...
    internal static class DateTimeCore
    {
        ...
        internal static long AgeYears(DateTime b, DateTime? r = null) { var rd = r ?? DateTime.Today; int a = rd.Year - b.Year; if (rd.Month < b.Month || (rd.Month == b.Month && rd.Day < b.Day)) a--; return a; }
        internal static long AgeMonths(DateTime b, DateTime? r = null) { var rd = r ?? DateTime.Today; return (rd.Year - b.Year) * 12 + rd.Month - b.Month - (rd.Day < b.Day ? 1 : 0); }
        internal static long AgeDays(DateTime b, DateTime? r = null) => (long)((r ?? DateTime.Today) - b).TotalDays;
        ...
        internal static long DateDiff(string u, DateTime d1, DateTime d2) => u.ToUpperInvariant() switch { "D" or "DAY" => (long)(d2 - d1).TotalDays, "M" or "MONTH" => ((d2.Year - d1.Year) * 12 + d2.Month - d1.Month), "Y" or "YEAR" => d2.Year - d1.Year - (d2.Month < d1.Month || (d2.Month == d1.Month && d2.Day < d1.Day) ? 1 : 0), _ => 0 };
    }
}
